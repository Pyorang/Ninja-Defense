...
public class DashAttackEffectFactory : MonoBehaviour
{
    [Header("프리팹")]
    [Space]
    ...
    private static DashAttackEffectFactory s_Instance;
    public static DashAttackEffectFactory Instance => s_Instance;
